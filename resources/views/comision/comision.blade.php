                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control w-75 mr-5 " id="type"
                                                                name="TnMahalKhsr">
                                                                @foreach (\App\placeKh::all() as $place)
                                                                    <option value="{{ $place->tashKhsr }}">
                                                                        {{ $place->tashKhsr }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>

                                                        <div>
                                                            <label for="message-text" name="ShHerasatsr"
                                                        ...
                                                        <div>
                                                            <label for="message-text" name="TdHerasatsr"
                                                                class="col-form-label mr-4">تائید حراست:</label>
                                                            <input type="text" class="form-control w-50 m-auto"
                                                                name="TdHerasatsr" id="TdHerasatsr"
                                                                value="{{ old('name', $item->TdHerasatsr) }}">
                                                        </div>

                                                        <div>
                                                            <label for="message-text" name="ShToliatsr"
                                                        ...
                                                        <div>
                                                            <label for="message-text" name="TdToliatsr"
                                                                class="col-form-label mr-4">تائید تولیت:</label>
                                                            <input type="text" class="form-control w-50 m-auto"
                                                                name="TdToliatsr" id="TdToliatsr"
                                                                value="{{ old('name', $item->TdToliatsr) }}">
                                                        </div>
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div>
                                                            <label for="message-text" name="SiMKhodamsr"
                                                                class="col-form-label mr-4">امضای مدیریت خدام:</label>
                                                            <input type="text" class="form-control w-50 m-auto"
                                                                name="SiMKhodamsr" id="SiMKhodamsr"
                                                                value="{{ old('name', $item->SiMKhodamsr) }}">
                                                        </div>

                                                        <div>
                                                            <label for="message-text" name="SiMSarmayehsr"
                                                                class="col-form-label mr-4">امضای سرمایه انسانی:</label>
                                                            <input type="text" class="form-control w-50 m-auto"
                                                                name="SiMSarmayehsr" id="SiMSarmayehsr"
                                                                value="{{ old('name', $item->SiMSarmayehsr) }}">
                                                        </div>

                                                        <div>
                                                            <label for="message-text" name="SiMAalesr"
                                                                class="col-form-label mr-4">امضای مدیریت عالی:</label>
                                                            <input type="text" class="form-control w-50 m-auto"
                                                                name="SiMAalesr" id="SiMAalesr"
                                                                value="{{ old('name', $item->SiMAalesr) }}">
                                                        </div>

                                                        <div>
                                                            <label for="message-text" name="SiToliatsr"
                                                                class="col-form-label mr-4">امضای تولیت:</label>
                                                            <input type="text" class="form-control w-50 m-auto"
                                                                name="SiToliatsr" id="SiToliatsr"
                                                                value="{{ old('name', $item->SiToliatsr) }}">
                                                        </div>
