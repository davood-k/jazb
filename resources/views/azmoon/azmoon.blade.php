...
{{-- امتیاز بیشتر مساوی 70 --}}
                                 ...
                                 <form method="post" action="comision/{{ $user->id }}">
                                  @csrf
                                  @method('put')
                                  <input type="hidden" class="form-control w-25 m-auto" name="ShDarComision" id="ShDarComision" value="1">
                                  <input type="hidden" class="form-control w-25 m-auto" name="dalil" id="dalil" value="قبولی در آزمون">
                                    <button class="btn btn-sm btn-warning mr-2">انتقال به کمیسیون</button>
                                  </form>

                                 @elseif($item->nomrehAzmoonsr < 70 && $user->marhalesr == 3)
                                 <a class="btn btn-danger mr-2" data-toggle="modal" data-target=".myModal-{{$user->id}}">بایگانی</a>
                                       ...
                                       <div class="modal-content">
                                         ...
                                         <form method="post" action='{{ url('/person/edit' , $user->id )}}'>
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <input type="hidden" class="form-control w-50" name="bayegan" id="bayegan"  value="1">
...
{{-- امتیاز کمتر از 70 یا بدون نمره --}}
                                ...
                                <a class="btn btn-sm btn-danger ml-2" data-toggle="modal" data-target=".myModal-{{$user->user_id}}">بایگانی</a>
                                ...
                                <div class="modal-dialog">
                                   ...
                                   <div class="modal-content">
                                     ...
                                     <form method="post" action='azmoon/{{ $user->id }}/sabt'>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-sm btn-primary">ثبت نمره</button>
                                          </div>
                                      </form>
